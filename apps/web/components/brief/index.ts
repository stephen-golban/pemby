// The Brief's own pieces (PLAN D6, D7). Operate density on the landing's world: hairline-ruled
// rows, outline-pill secondary actions, no boxes around cells, no tilt.
...
export { TierVerdict } from "./tier-verdict";
export { useReasonText } from "./reasons";
